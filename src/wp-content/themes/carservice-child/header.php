			...
			<div class="vertical-align-table">
				<div class="header clearfix">
					<div class="wrapper-header-logo">
						...
						<!-- Menu -->
						<div class="header-search-bar-container w-50">
							<?php
					...
					<div class="header-middle-bar-container">
						<?php
						$sidebar_menu = get_post($theme_options["header_top_right_sidebar"]);
						if (isset($sidebar_menu) && !(int)get_post_meta($sidebar_menu->ID, "hidden", true) && is_active_sidebar($sidebar_menu->post_name)) :
						?>
							<div class="main-menu-container">
								<?php
								dynamic_sidebar($sidebar_menu->post_name);
								?>
							</div>
