...
$output .= "\n\t\t".'<ul class="accordion'.(isset($width) ? esc_attr($width) : '').esc_attr($el_class) . ($top_margin!="none" ? ' ' . esc_attr($top_margin) : '') .'" data-collapsible='.esc_attr($collapsible).'  data-vc-disable-keydown="' . ( esc_attr( ( 'yes' == $disable_keyboard ? 'true' : 'false' ) ) ) . '" data-active-tab="'.esc_attr($active_tab).'">';
